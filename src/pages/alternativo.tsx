...
const Alternativo = () => {
  ...
  return (
    <div className="bg-gradient-to-b from-cyan-100 from-10% via-cyan-50 via-30% to-white to-90% bg-fixed">
        <header id="header" className="pt-10 lg:text-left xl:pb-10">
          <HeaderComponent />
        ...
        <section id="features" className="mx-auto max-w-6xl lg:pt-24 pt-20 px-4 sm:px-8">

            <div className="mb-10 text-center lg:text-left mx-auto">
          ...
          <p className="mt-4 text-lg/8 text-gray-600">
            ...
            <div className="flex flex-col lg:flex-row sm:gap-x-4 gap-y-4 mt-8 sm:mt-20 lg:mt-12" >

                <div className="flex-1 bg-white flex flex-col items-center p-10 rounded-xl">
        ...
        <section id="features2" className="mx-auto max-w-6xl lg:pt-24 pt-20 px-4 sm:px-8 grid grid-cols-5">

            <div className="mb-10 text-center lg:text-left mx-auto col-span-2">
                <p className="mt-2 text-pretty text-3xl font-semibold tracking-tight text-gray-900 sm:text-4xl lg:text-balance">
                    Uma empresa digital e <span className="text-gradient">multidisciplinar</span>
                </p>
                <p className="mt-4 text-lg/8 text-gray-600">
            ...
            <div className="flex flex-col sm:gap-x-4 gap-y-4 mt-8 sm:mt-20 lg:mt-0 w-full col-span-3" >

                <div className="flex-1 bg-white border border-white shadow flex items-start p-10 rounded-xl w-full">
                    <div className="bg-white rounded-full p-7 mr-6 bg-amarelo">
                        <img src={DesignDeServicoImagem} className="w-20  fill-white" alt="alternative" />
                    </div>
                    <div className=" text-black">
                        <h5 className="mb-2 text-black">Design de Serviço</h5>
                        <p className="mb-6 text-black">Te ajudamos a inovar, criando um serviço encantador que supere as expectativas dos clientes e destaque seu diferencial.</p> 
                        <p className='text-black'> <strong>Como?</strong> <br /> Entendendo seu público e desenhando uma oferta coerente, que vá além da experiência e considere o lado da empresa na hora de fazer ajustes. </p>
                        {/* <button onClick={() => openModal('design-de-servico')} className="border border-gray-900 text-gray-900 font-medium hover:bg-gray-900 hover:text-white px-6 py-3 popup-with-move-anim rounded-full">Saiba Mais</button> */}
                    </div>
                </div>
        ...
        <section className="App"> 
            <Modal isOpen={modalIsOpen} onRequestClose={closeModal} className="bg-white absolute top-[50%] left-[50%] right-auto bottom-auto translate-x-[-50%] translate-y-[-50%] -mr-[50%] p-10 md:p-20 max-w-[600px] rounded-xl" style={customStyles}> 
                ...
                {modalContent === 'design-de-servico' && ( 
                    <div> 
                        <div className="flex items-center mb-4">
                            <img className="h-9 mr-4" src={DesignDeServicoImagem} alt="Imagem: Design de Serviço" />
                            <h3 className="mb-2">
                                Design de Serviço 
                            </h3>
                        </div>
